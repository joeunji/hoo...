...
<tr>
<td><input type="button" value="아이디 찾기" onClick="event('idFindPageform','idFindPage','post')" /></td>
</tr>
<tr>
<td><input type="button" value="회원가입" onClick="event('joinPageform','joinPage','post')" /></td>
</tr>
<tr>
